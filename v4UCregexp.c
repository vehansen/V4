# define gettext(msgid) (L ## msgid)
#define gettext_noop(String) (L ## String)
...
#define ISWORD(c) (uci->Entry[c].IsBgnId || uci->Entry[c].IsContId)
...
#define STREQ(s1, s2) ((UCstrcmp (s1, s2) == 0))
...
int
vregexp_RegExec (preg, string, nmatch, pmatch, eflags)
    regex_t *preg;
    char *string;
    size_t nmatch;
    regmatch_t pmatch[];
