...
/*	To Build on Windows-
	  cl /O2 /Fexxxcgi.exe /W1 -D XXX=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib

	  cl /O2 /Fefrdcgi.exe /w -D FRD=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib

	  
	  cl /O2 /Feycmidasx.exe /w -D YCONEWELL=1 -DNT486=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib
	  cl /O2 /Feycwebx.exe /w -D YCFNEWELL=1 -DNT486=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib

	  cl /O2 /Fewwpxpcgi.exe /w -D WWPXP=1 -D GETADDR=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib
	  cl /O2 /Fewwpwjthome.exe /w -D WWPWJTHOME=1 -D NT486=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib
	  cl /O2 /Fewwpmks.exe /w -D WWPMKS=1 -D NT486=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib
	  cl /O2 /Fewwp2011.exe /w -D WWP2011=1 -D NT486=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib

	  cl /O2 /Feenvcgi.exe /w -D ENVIRONMENT=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib

	  cl /O2 /Fecgmmkscgi.exe /w -D CGMMKS=1 -DNT486=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib
	  cl /O2 /Fecgmcgi.exe /w -D CGM=1 -DNT486=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib

	MTS
	  cl /O2 /Femtsmkscgi.exe /w -D MTSMKS=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib

	  cl /O2 /Fepsfmks.exe /w -D PSFMKS=1 -DNT486=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib

	GWR
	  cl /O2 /Fegwrmks.exe /w -D GWRMKS=1 -DNT486=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib
	  cl /O2 /Fegwrcmks.exe /w -D GWRCMKS=1 -DNT486=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib
	  cl /O2 /Fegwrprod.exe /w -D GWRPROD=1 -DNT486=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib

	TGF
	  cl /O2 /Fetgfmks.exe /w -D TGFMKS=1 -DNT486=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib
	  cl /O2 /Fetgfsts.exe /w -D TGFSTS=1 -DNT486=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib

	CWC
	  cl /O2 /Fecwcmks.exe /w -D CWCMKS=1 -DNT486=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib
	  cl /O2 /Fecwcaws.exe /w -D CWCAWS=1 -DNT486=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib

	GNT
	  cl /O2 /Fegntmks.exe /w -D GNTMKS=1 -DNT486=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib
	  cl /O2 /Fegntaws.exe /w -D GNTAWS=1 -DNT486=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib

	BKG
	  cl /O2 /Febkfmks.exe /w -D BKFMKS=1 -DNT486=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib
	  cl /O2 /Febkfctw.exe /w -D BKFCTW=1 -DNT486=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib

	MDF
	  cl /O2 /Femdfmks.exe /w -D MDFMKS=1 -DNT486=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib

	SMT
	  cl /O2 /Fesmtaws.exe /w -D SMTAWS=1 -DNT486=1 v4cgi.c kernel32.lib wsock32.lib advapi32.lib user32.lib
...
#define CGI_LOG_PREFIX "v4"

#ifdef XXX
  #define V4SERVERNAME "192.168.120.146/2350"		/* IP Address of (veh) V4 server running test on MKS network */
  #define CGI_LOG_PREFIX "xxx"
#elif defined FRD
//  #define V4SERVERNAME "192.168.120.146/2360"		/* IP Address of V4 server when running FRD on VEH machine */
  #define V4SERVERNAME "192.168.120.131/2355"		/* IP Address of V4 server when running WWPX2 on IBG machine */
  #define CGI_LOG_PREFIX "frd"
#elif YCONEWELL
#define V4SERVERNAME "10.23.0.67/2510"			/* YCO (MIDAS) running on Newell archive server*/
#define CGI_LOG_PREFIX "ycmidasx"
#elif YCFNEWELL
#define V4SERVERNAME "10.23.0.67/2509"			/* YC-Web running on Newell archive server*/
#define CGI_LOG_PREFIX "ycwebx"
#elif WWPXP
#define V4SERVERNAME "192.168.3.10/2353"		/* IP Address of V4 server from WWPXP Web Server */
#define CGI_LOG_PREFIX "wwpxp"
#elif WWPWJTHOME
#define V4SERVERNAME "192.168.109.172/2352"		/* IP Address of WWP - WJT - HOME  */
#define CGI_LOG_PREFIX "wwpwjthome"
#elif WWPMKS
#define V4SERVERNAME "192.168.122.173/2352"		/* IP Address of WWP - MKS Office */
#define CGI_LOG_PREFIX "wwpmks"
#elif WWP2011
#define V4SERVERNAME "192.168.3.172/2352"		/* IP Address of WWP new (as of nov-2020) server */
#define CGI_LOG_PREFIX "wwp2011"
#elif WWP2
  #define V4SERVERNAME "192.168.3.10/2353"		/* IP Address of alternate V4 server from WWP Web Server */
  #define CGI_LOG_PREFIX "wwp2"
#elif WWPX2MKSInc
  #define V4SERVERNAME "192.168.120.134/2376"		/* IP Address of server on MKS Test WWPX2 Web Server */
//  #define V4SERVERNAME "192.168.120.19/2355"		/* We want this to go to WWP new server for as long as it is at MKS so we can test web stuff VEH111215 */
  #define CGI_LOG_PREFIX "wwpx2"
#elif WWPX2
  #define V4SERVERNAME "192.168.120.19/2355"		/* IP Address of server on WWP's new V4 server running at MKS Test Web Server */
  #define CGI_LOG_PREFIX "wwpx2"
#elif WWPWP
  #define V4SERVERNAME "192.168.3.10/2354"		/* IP Address of server on WWP's Word Press server to link to V4 server */
  #define CGI_LOG_PREFIX "wwpwp"
#elif defined MTSMKS
  #define V4SERVERNAME "192.168.120.134/2367"		/* IP Address of MTS running on MKS server */
  #define CGI_LOG_PREFIX "mtsmks"
#elif defined CGMMKS
  #define V4SERVERNAME "192.168.120.134/2350"		/* IP Address of CGM running on MKS server */
  #define CGI_LOG_PREFIX "cgmmks"
#elif defined CGM
  #define V4SERVERNAME "192.168.0.7/2350"		/* IP Address of CGM live server */
  #define CGI_LOG_PREFIX "cgm"
#elif defined CWCMKS					/* CWC on MKS */
  #define V4SERVERNAME "192.168.120.134/2368"
  #define CGI_LOG_PREFIX "cwcmks"
#elif defined CWCAWS					/* CWC on AWS */
  #define V4SERVERNAME "10.200.166.25/2368"
  #define CGI_LOG_PREFIX "cwcaws"
#elif defined BKFMKS					/* BKF running on MKS server */
  #define V4SERVERNAME "192.168.120.134/2362"
  #define CGI_LOG_PREFIX "bkf"
#elif defined BKFCTW					/* BKF running on connectwise server */
  #define V4SERVERNAME "192.168.0.15/2362"
  #define CGI_LOG_PREFIX "bkf"
#elif defined MDFMKS					/* MDF running on MKS server */
  #define V4SERVERNAME "192.168.120.134/2371"
  #define CGI_LOG_PREFIX "mdf"
#elif defined SMTAWS					/* SMT running on AWS server */
  #define V4SERVERNAME "172.26.5.16/2361"
  #define CGI_LOG_PREFIX "smt"
#elif defined GNTMKS					/* GNT running on MKS server */
  #define V4SERVERNAME "192.168.120.134/2363"
  #define CGI_LOG_PREFIX "gnt"
#elif defined GNTAWS					/* GNT running on AWS server */
  #define V4SERVERNAME "172.26.9.35/2363"
  #define CGI_LOG_PREFIX "gnt"
#elif defined GWRMKS					/* GWR running on MKS server */
  #define V4SERVERNAME "192.168.120.134/2364"
  #define CGI_LOG_PREFIX "gwr"
#elif defined PSFMKS					/* PSF running on MKS server */
  #define V4SERVERNAME "192.168.120.134/2369"
  #define CGI_LOG_PREFIX "psf"
#elif defined GWRCMKS					/* GWR running on MKS server */
  #define V4SERVERNAME "192.168.120.203/2364"
  #define CGI_LOG_PREFIX "gwrc"
#elif defined GWRPROD					/* GWR running on their server */
  #define V4SERVERNAME "172.16.0.7/2364"
  #define CGI_LOG_PREFIX "gwr"
#elif defined TGFMKS					/* TGF running on MKS server */
  #define V4SERVERNAME "192.168.120.134/2370"
  #define CGI_LOG_PREFIX "tgf"
#elif defined TGFSTS					/* TGF running on their server */
  #define V4SERVERNAME "192.168.1.5/2370"
  #define CGI_LOG_PREFIX "tgf"
#elif ENVIRONMENT
...
//	   strcpy(sbuf,"GET q=") ; strcat(sbuf,queryString) ; vcgi_Log(sbuf) ;
	 ...
	 { int res ;
	   ...
	   if (contentLen <= 0 || contentLen > 10000000)
	    { char buf[512] ; char *cl = getenv("CONTENT_LENGTH") ;
	      ...
	      vcgi_Log(buf) ;
//	      vcgi_Log("? Content length must be greater than 0 & less than 5mb") ;
	      vcgi_ErrExit() ;
	    } ;
